...
Insert into "USER" (USER_ROLE_FK,USER_NAME,USER_SURNAME,USER_EMAIL,USER_PASSWORD,MIDDLE_NAME) values ('Студент','Федір','Федоров','fed123@gmail.com','fedfed','Федорович');
Insert into "USER" (USER_ROLE_FK,USER_NAME,USER_SURNAME,USER_EMAIL,USER_PASSWORD,MIDDLE_NAME) values ('Студент','Іван','Іванов','ivanov@mail.com','ivan111','Іванович');
Insert into "USER" (USER_ROLE_FK,USER_NAME,USER_SURNAME,USER_EMAIL,USER_PASSWORD,MIDDLE_NAME) values ('Викладач','Борис','Борисов','boris_1@gmail.com','123456','Борисович');
Insert into "USER" (USER_ROLE_FK,USER_NAME,USER_SURNAME,USER_EMAIL,USER_PASSWORD,MIDDLE_NAME) values ('Викладач','Сергій','Сергієнко','serg@gmail.com','789456','Сергійович');
Insert into WISHLIST (SUBJECT_NAME_FK1,USER_EMAIL_FK1,WISH_DATE,WISH_ID) values ('Математичний аналіз','fed123@gmail.com',to_date('30-11-2018 14:40','DD-MM-YYYY HH24:MI'),'1');
Insert into WISHLIST (SUBJECT_NAME_FK1,USER_EMAIL_FK1,WISH_DATE,WISH_ID) values ('Вища математика','ivanov@mail.com',to_date('01-12-2018 13:30','DD-MM-YYYY HH24:MI'),'2');
Insert into WISHLIST (SUBJECT_NAME_FK1,USER_EMAIL_FK1,WISH_DATE,WISH_ID) values ('Вища математика','fed123@gmail.com',to_date('01-12-2018 13:30','DD-MM-YYYY HH24:MI'),'3');
Insert into WISHLIST (SUBJECT_NAME_FK1,USER_EMAIL_FK1,WISH_DATE,WISH_ID) values ('Англійська мова','ivanov@mail.com',to_date('03-12-2018 10:00','DD-MM-YYYY HH24:MI'),'4');
